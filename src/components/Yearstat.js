...
//year data of epense monthsum
  async function fetchyerData() {
    setfsuc(false);
    const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Details_Yearly", {
   method: 'POST',
   headers: {
...
async function typewiseyrdata(){
  setfsuc(false);
  const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_TypeWise_Yearly", {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json'
    },
