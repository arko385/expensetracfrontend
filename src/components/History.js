...
async function fetchData() {
  setfsuc(false);
  //https://expense-tracker-1qp3.onrender.com
 // https://coin-book-app-backend-mern4.onrender.com
  const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Sum_Daily", {
 method: 'POST',
 headers: {
...
async function fetchmoData() {
  setfsuc(false);
  const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Sum_Monthly", {
 method: 'POST',
 headers: {
     'Content-Type': 'application/json'
 },
...
async function fetchyrData() {
  setfsuc(false);
  const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Sum_Yearly", {
 method: 'POST',
 headers: {
     'Content-Type': 'application/json'
 },
...
const expensehandleSubmit = async (e) => {
  ...
  const value=expense.val
    // e.preventDefault();
    const response = await fetch("https://expense-tracker001.onrender.com/user/add_User_Expense_Daily", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const updateexpense = async (e) => {
  setfsuc(false);
    const response = await fetch("https://expense-tracker001.onrender.com/user/update_Any_User_Expense_", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function fetchexpensetype() {
  setfsuc(false);
  const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Types", {
 method: 'POST',
 headers: {
     'Content-Type': 'application/json'
 },
...
const deleteexpense = async () => {
  setfsuc(false);
  const response = await fetch("https://expense-tracker001.onrender.com/user/delete_User_Expense", {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json'
      },
...
//fetch daywise expense details
  const handleSubmit = async (e) => {
    ...
    var day=date?((parseInt(date.substring(8))).toString()):localStorage.getItem("day");
      ...
      // console.log(day);
      // console.log(year);
      const response = await fetch("https://expense-tracker001.onrender.com/user/fetch_User_Expense_Details_Daily", {
          method: 'POST',
          headers: {
              'Content-Type': 'application/json'
          },
